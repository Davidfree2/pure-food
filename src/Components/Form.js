...
const Form = () => {
    ...
    const loading = () => {
        if ( email.current.value ) {
            ...
            submitButton.current.innerText = 'enter email!';
    ...
    return (
        ...
        <div class='flex-col items-center justify-center p-10 w-full'>
            ...
            <form class='w-1/2'>
                <input ref={email} class='tracking-wide leading-3 focus:outline-none border-b-2 border-black bg-emerald-100 w-5/12 mr-4 p-2 pl-1 text-lg mb-4' type='text' placeholder='First Name'/>
